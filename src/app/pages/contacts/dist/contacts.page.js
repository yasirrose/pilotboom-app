...
var ContactsPage = /** @class */ (function () {
    function ContactsPage(api, global, router, alertCtrl, toastCtrl, navCtrl, navParam) {
        this.api = api;
        this.global = global;
        this.router = router;
    ...
    ContactsPage.prototype.resetData = function () {
        this.hasMore = true;
        this.page = 1;
        this.per_page = 10;
        this.content.scrollToTop();
    };
    ContactsPage.prototype.clearSearch = function () {
        this.search = false;
        this.searchTerm = '';
        this.searching = false;
    };
    ContactsPage.prototype.getContacts = function (event, refresh) {
        var _this = this;
        this.api.getCrmContacts('contact', 'all', this.per_page, this.page).subscribe(function (res) {
            ...
            _this.contactsData = _this.contactsData.concat(res);
            if (event && _this.search && _this.searchTerm) { //Pagination called and search exists already
                var filtered = _this.global.filterSearch(_this.contactsData, _this.searchTerm, 'first_name', 'last_name');
                _this.setData(filtered);
            }
            else {
                _this.setData(_this.contactsData);
            }
    ...
    ContactsPage.prototype.setData = function (contactData) {
        this.all = [];
        this.customer = [];
        this.lead = [];
        this.opportunity = [];
    ...
    ContactsPage.prototype.getDetail = function (event, id) {
    ...
    ContactsPage.prototype.editContact = function (event, id) {
        var navigationExtras = {
            queryParams: {
                contactId: id
            }
    ...
    ContactsPage.prototype["delete"] = function (event, id) {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        _this.api.deleteContact(id).subscribe(function (res) {
                                            _this.contactsData = _this.global.filterObjectByValue(_this.contactsData, 'id', id, 'remove');
                                            _this.setData(_this.contactsData);
    ...
    ContactsPage.prototype.permanentDelete = function (event, id) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ContactsPage.prototype.loadMore = function (event) {
        this.page++;
        this.getContacts(event);
    };
    ContactsPage.prototype.doRefresh = function (event) {
        this.resetData();
        this.getContacts(event, true);
    };
    ContactsPage.prototype.enableSearch = function (evt) {
        this.search = !this.search;
        if (!this.search) {
            this.searchTerm = '';
        }
    };
    ContactsPage.prototype.filterItems = function (evt) {
        var _this = this;
        this.searching = true;
    ...
    ], ContactsPage.prototype, "content");
