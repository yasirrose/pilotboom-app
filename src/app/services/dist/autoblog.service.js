...
var AutoblogService = /** @class */ (function () {
    ...
    AutoblogService.prototype.getAutoBlog = function (per_page, page) {
        ...
        return this.http.get(this.global.getApiUrl() + "/autoblog/v1/blogs?per_page=" + per_page + "&page=" + page, { headers: headers }).pipe(operators_1.map(function (data) {
            return data;
        }));
    };
