...
var FcmService = /** @class */ (function () {
    function FcmService(router, global) {
        this.router = router;
        this.global = global;
    }
    FcmService.prototype.initPush = function () {
        if (core_2.Capacitor.platform !== "web") {
            this.registerPush();
        }
    };
    FcmService.prototype.registerPush = function () {
        ...
        PushNotifications.addListener("registration", function (token) {
            ...
            _this.global.setDeviceToken(token);
        });
        ...
        PushNotifications.addListener("pushNotificationActionPerformed", function (notification) { return __awaiter(_this, void 0, void 0, function () {
