...
var ChatService = /** @class */ (function () {
    function ChatService(http, storage, plt, global
    ...
    ChatService.prototype.resendMsg = function (id) {
        return this.http.post(this.global.getApiUrl() + "/erp/v1/messaging/texts/resend", { id: id }).pipe(operators_1.map(function (data) {
            return data;
        }));
    };
    ...
    ChatService.prototype.saveToken = function () {
        ...
        return this.http.post(this.global.getApiUrl() + "/erp/v1/messaging/save_token", { token: this.global.getDeviceToken() }).pipe(operators_1.map(function (data) {
            return data;
        }));
    };
