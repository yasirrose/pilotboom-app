...
var all_enum_1 = require("../enum/all.enum");
...
function () {
  function RestService(http, storage, plt, global) {
    ...
    console.log(all_enum_1.All.apiUrl);
  }

  RestService.prototype.signIn = function (username, password) {
    var _this = this;

    return this.http.post(this.global.getApiUrl() + "/jwt-auth/v1/token", {
      username: username,
      password: password
  ...
  RestService.prototype.signUp = function (username, email, password) {
    return this.http.post(this.global.getApiUrl() + "/wp/v2/users/register", {
      username: username,
      email: email,
      password: password
    });
  ...
  RestService.prototype.resetPassword = function (usernameOrEmail) {
    return this.http.post(this.global.getApiUrl() + "/wp/v2/users/lostpassword", {
  ...
  RestService.prototype.getMasterData = function (domain, action) {
    ...
    } // All.apiUrl = 'WEJKFNWEKF';


    return this.http.get("https://demo.pilotboom.com/wp-json/wp/v2/users").pipe(operators_1.map(function (data) {
      return data;
    }));
  };
  ...
  RestService.prototype.getPosts = function (per_page, page) {
    ...
    return this.http.get(this.global.getApiUrl() + "/wp/v2/posts?per_page=" + per_page + "&page=" + page, {
      headers: headers
  ...
  RestService.prototype.getUsers = function () {
    var headers = new http_1.HttpHeaders();
    headers = headers.set('Authorization', 'Bearer ' + JWT_KEY);
    return this.http.get(this.global.getApiUrl() + "/wp/v2/users", {
      headers: headers
    }).pipe(operators_1.map(function (data) {
      return data;
    }));
  ...
  RestService.prototype.getCrmContacts = function (type, status, per_page, page, search, include_owner) {
    ...
    if (include_owner === void 0) {
      include_owner = true;
    }

    var headers = new http_1.HttpHeaders();
    headers = headers.set('Authorization', 'Bearer ' + JWT_KEY);
    return this.http.get(this.global.getApiUrl() + "/erp/v1/crm/contacts?type=" + type + "&status=" + status + "&per_page=" + per_page + "&page=" + page + "&search=" + search + (include_owner ? '&include=owner' : ''), {
      headers: headers
    }).pipe(operators_1.map(function (data) {
      return data;
    }));
  ...
  RestService.prototype.CountCrmContacts = function (contact, company) {
    ...
    var headers = new http_1.HttpHeaders();
    headers = headers.set('Authorization', 'Bearer ' + JWT_KEY);
    return this.http.get(this.global.getApiUrl() + "/erp/v1/crm/contacts/count?contact=" + contact + "&company=" + company, {
      headers: headers
    }).pipe(operators_1.map(function (data) {
      return data;
    }));
  ...
  RestService.prototype.getContactDetail = function (id, include_owner) {
    ...
    var headers = new http_1.HttpHeaders();
    headers = headers.set('Authorization', 'Bearer ' + JWT_KEY);
    return this.http.get(this.global.getApiUrl() + "/erp/v1/crm/contacts/" + id + (include_owner ? '?include=owner' : ''), {
      headers: headers
    }).pipe(operators_1.map(function (data) {
      return data;
    }));
  ...
  RestService.prototype.getCrmContactGroups = function (page, per_page, search) {
    ...
    var headers = new http_1.HttpHeaders();
    headers = headers.set('Authorization', 'Bearer ' + JWT_KEY);
    return this.http.get(this.global.getApiUrl() + "/erp/v1/crm/contacts/groups?per_page=" + per_page + "&page=" + page + "&search=" + search, {
      headers: headers
    }).pipe(operators_1.map(function (data) {
      return data;
    }));
  ...
  RestService.prototype.getContactGroupDetail = function (contactGrpId) {
    var headers = new http_1.HttpHeaders();
    headers = headers.set('Authorization', 'Bearer ' + JWT_KEY);
    return this.http.get(this.global.getApiUrl() + "/erp/v1/crm/contacts/groups/" + contactGrpId, {
      headers: headers
    }).pipe(operators_1.map(function (data) {
      return data;
    }));
  ...
  RestService.prototype.getContactGrpSubs = function (contactGrpId, page, per_page) {
    ...
    var headers = new http_1.HttpHeaders();
    headers = headers.set('Authorization', 'Bearer ' + JWT_KEY);
    return this.http.get(this.global.getApiUrl() + "/erp/v1/crm/contacts/groups/" + contactGrpId + "/subscribes?per_page=" + per_page + "&page=" + page, {
      headers: headers
    }).pipe(operators_1.map(function (data) {
      return data;
    }));
  ...
  RestService.prototype.subscribeContact = function (group_id, contact_ids) {
    var headers = new http_1.HttpHeaders();
    headers = headers.set('Authorization', 'Bearer ' + JWT_KEY);
    return this.http.post(this.global.getApiUrl() + "/erp/v1/crm/contacts/groups/" + group_id + "/subscribes", {
  ...
  RestService.prototype.getActivities = function (customer_id, per_page, page, type) {
    ...
    if (type === void 0) {
      type = 'log%7Cnote%7Cemail%7Cschedule%7Ctask';
    }

    var headers = new http_1.HttpHeaders();
    headers = headers.set('Authorization', 'Bearer ' + JWT_KEY);
    return this.http.get(this.global.getApiUrl() + "/erp/v1/crm/activities?type=" + type + "&per_page=" + per_page + "&page=" + page + "&customer_id=" + customer_id, {
      headers: headers
    }).pipe(operators_1.map(function (data) {
      return data;
    }));
  ...
  RestService.prototype.getActivityDetail = function (id) {
    var headers = new http_1.HttpHeaders();
    headers = headers.set('Authorization', 'Bearer ' + JWT_KEY);
    return this.http.get(this.global.getApiUrl() + "/erp/v1/crm/activities/" + id, {
      headers: headers
    }).pipe(operators_1.map(function (data) {
      return data;
    }));
  ...
  RestService.prototype.getSchedules = function (tab, per_page, page) {
    ...
    var headers = new http_1.HttpHeaders();
    headers = headers.set('Authorization', 'Bearer ' + JWT_KEY);
    return this.http.get(this.global.getApiUrl() + "/erp/v1/crm/schedules?tab=" + tab + "&per_page=" + per_page + "&page=" + page, {
      headers: headers
    }).pipe(operators_1.map(function (data) {
      return data;
    }));
  ...
  RestService = __decorate([core_1.Injectable({
    providedIn: 'root'
  })], RestService);
  return RestService;
}();
